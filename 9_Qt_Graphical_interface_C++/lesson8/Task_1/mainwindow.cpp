    ...
    , ui(new Ui::MainWindow)
{
    ...
    QAction *actPasteDateTime = menu->addAction("Вставить дату и время");
    ...
    connect(actPasteDateTime, SIGNAL(triggered()), this, SLOT(pasteDateTime()));
...
void MainWindow::pasteDateTime()
{
    ...
    QString dateAndTime = dateTime.toString("dd.MM.yyyy hh:mm:ss");
    qDebug()<<dateAndTime;
    ui->plainTextEdit->textCursor().insertText(dateAndTime);
}
